...
global file_cross   "Y99_1400_have_educ"      // Cross-section file (Wide or Long format setup)
global file_panel   "Y99_1400_have_educ_long" // Panel file (Long format) for Section 5
global output_log   "parametric_results" // Name of the log file

* 2. DEFINE YEARS
global yr1 "99"  // Suffix for the first year (e.g., 98, 05, 2010)
global yr2 "1400"  // Suffix for the second year (e.g., 99, 10, 2015)
