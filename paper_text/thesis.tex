...
The \$8.30 per day threshold, measured in 2021 Purchasing Power Parity (PPP), is the World Bank's updated poverty line for assessing poverty in upper-middle-income countries \citep{Foster2025GlobalPoverty,WorldBank2025GlobalPovertyLines}. It is derived by expressing updated national poverty lines in 2021 international dollars and taking the median across countries classified as upper-middle income at the time of their latest national poverty line; the estimated median of \$8.29 is rounded to \$8.30 \citep{Foster2025GlobalPoverty}. This line is part of a revised tiered measurement system that also includes an international extreme poverty line of \$3.00 and a lower-middle-income line of \$4.20. Under the 2021 PPP update, these thresholds replace the corresponding 2017 PPP lines of \$2.15, \$3.65, and \$6.85, respectively, for the World Bank's primary global poverty reporting \citep{WorldBank2025GlobalPovertyLines}.

The use of the 2021 PPP update, including the \$8.30 line, is methodologically justified for several reasons. First, it aligns the analysis with the World Bank's current reporting framework and with the most recent benchmark price comparisons produced by the International Comparison Program. PPPs are not static, and the 2021 benchmark incorporates updated information on relative price levels and more recent national poverty lines \citep{Foster2025GlobalPoverty}. Second, it preserves \emph{cross-country consistency} by expressing household welfare against a common standard that accounts for differences in purchasing power, which is essential for international poverty comparisons \citep{Ravallion2016}. Third, it addresses a measurement gap in \emph{higher development contexts}, where the extreme poverty line is often too low to capture the economic vulnerability relevant to upper-middle-income countries \citep{Ferreira2016}. Finally, applying a single 2021 PPP framework across all survey years avoids combining thresholds from different PPP vintages and keeps the analysis consistent with the current Poverty and Inequality Platform \citep{WorldBankPIP2026}.

For the empirical implementation, the daily PPP threshold is expressed as a monthly per-capita poverty line in Iranian rials for each HIES year. The resulting lines applied in the analysis are 5{,}863{,}711 rials in 1398, 8{,}205{,}691 rials in 1399, 12{,}571{,}554 rials in 1400, 17{,}671{,}052 rials in 1401, 22{,}258{,}561 rials in 1402, and 29{,}175{,}368 rials in 1403. A household is classified as poor when its monthly per-capita consumption falls below the corresponding year-specific threshold. These are the poverty lines used to construct the poverty-status variables and all poverty-transition estimates reported in the results section.

Nonetheless, PPP-based measures have recognized limitations. Changes in PPP benchmarks and in the national poverty lines underlying the global thresholds can revise the measured level of poverty even when the recent trend remains broadly similar \citep{Foster2025GlobalPoverty,WorldBank2025GlobalPovertyLines}. Critics also note that a uniform international threshold may not fully represent locally specific needs, spatial price differences, or national definitions of minimum living standards \citep{Reddy2008}. The World Bank therefore recommends national poverty lines for country-specific policy dialogue and targeting, while international lines are particularly useful for benchmarking and cross-country comparison \citep{WorldBank2025GlobalPovertyLines}. Consequently, this study uses the \$8.30 (2021 PPP) line as a consistent international benchmark while recognizing the complementary value of national poverty lines and multidimensional deprivation measures \citep{Alkire2011}.
